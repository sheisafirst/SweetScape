...
function RecipeList() {
  ...
  return (
    <div className="md:px-24">
      ...
      <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-4 mt-10 text-center">
        Add Recipes 
      </button>
      </Link>
